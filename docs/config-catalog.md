...
Requires: `tools` · `econswarm` · `subagents`
...
Source: [`packages/finance/tool-econswarm/src/index.ts:25`](../packages/finance/tool-econswarm/src/index.ts)
...
- `@deepseek-ai/dsh-skill-econswarm` — requires `skills` ([`packages/finance/skills-econswarm/src/index.ts`](../packages/finance/skills-econswarm/src/index.ts))
