...
import type { SidebarRootComponentProps, SidebarNavOwnerProps, SidebarSectionOwnerProps } from '../src/client/contract/slots.ts'
...
function mountColumn(): { column: HTMLElement; quiet: () => boolean } {
  const view = render(
    <SidebarRoot
      ...
      renderSlot={((_key: string, owner: SidebarNavOwnerProps | SidebarSectionOwnerProps) =>
        <div data-testid={_key === 'sidebar.nav' ? 'nav' : 'region'} data-wide={owner.wide} />) as SidebarRootComponentProps['renderSlot']}
    />,
  )
