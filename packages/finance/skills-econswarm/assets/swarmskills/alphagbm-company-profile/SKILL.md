...
name_zh: AlphaGBM 公司概况
description_zh: >
  在 AlphaGBM 上创建和维护公司研究档案——基于基本面、PE/PB 区间历史、财务红旗和事件雷达自动生成。每个档案是一个用户+标的记录，系统会定期自动刷新。使用场景：创建需要跟踪的公司列表、调取已保存的研究文件、刷新档案中的市场数据、或查看 PE/PB 区间。
  触发词："添加 AAPL 到我的知识库"、"显示我的 NVDA 档案"、"刷新我的 TSLA 档案"、"列出我跟踪的公司"、"META PE 区间"、"我的投研库里有什么"、"创建公司档案"、"我的投研档案"
---
