...
name_zh: AlphaGBM 持仓体检
description_zh: >
  针对用户研究知识库的每周诊断报告——标记过期档案（数周未更新）、论据偏离（AI 检测到原始前提已不再成立）以及孤立页面（有档案无论据、有主题但缺少档案）。返回总体 0-100 健康评分及具体行动建议。使用场景：审计知识库状态、触发新报告、查看需要关注的内容。
  触发词："运行一次健康检查"、"我的研究报告需要刷新吗"、"知识库审计"、"生成知识库报告"、"发现过期内容"、"论据偏离检测"、"研究库体检"、"过期档案"、"论据偏离"、"孤立主题"
---
...
```json
{
  ...
  "overall_score": 78,
  "stale_profiles": [{ "ticker": "AAPL", "days_since_update": 21 }],
  "thesis_drift": [
    { "ticker": "NVDA", "drift_reason": "Revenue growth now 12% vs 25% when thesis was written" }
  ],
  "orphan_pages": [{ "ticker": "XYZ", "issue": "Profile has no thesis after 30 days" }],
  "recommendations": [
