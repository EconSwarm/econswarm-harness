...
name_zh: AlphaGBM 宏观视图
description_zh: >
  跟踪真正影响你投资组合的宏观变量——VIX、美国10年期国债、美元指数、黄金、石油等——并自动计算对用户持仓的影响。每个跟踪指标返回当前值、变动幅度以及 AI 生成的影响分析（关联到用户的公司档案）。使用场景：添加宏观指标、调取当前宏观仪表板、询问 VIX 如何影响投资组合。
  触发词："跟踪 VIX"、"当前十年期国债收益率"、"美元怎么样了"、"添加黄金到我的宏观监控"、"移除 US10Y"、"宏观指标"、"美债利率"、"美元指数"、"VIX恐慌指数"
---
