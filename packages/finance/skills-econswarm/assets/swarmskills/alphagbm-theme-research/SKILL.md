...
description: >
  ...
  "主题研究", "AI基建", "港股高息", "投资主题".
name_zh: AlphaGBM 主题研究
description_zh: >
  将相关标的归类为投资主题——AI 基建、港股高息、电动车供应链、生物科技催化剂——并附带主题级别的 AI 摘要和新闻关键词监控。每个主题是一个命名标的集合加上系统为你监控的关键词。使用场景：创建主题篮子、调取主题聚合视图、添加/移除标的、监控某主题相关新闻。
  触发词："创建 AI 基建主题"、"显示我的主题"、"添加 MSFT 到 AI 主题"、"港股高息有什么新动态"、"主题研究"、"AI基建"、"港股高息"、"投资主题"
---
