---
name_en: audit-xls
description_en: Audit a spreadsheet for formula accuracy, errors, and common mistakes. Scopes to a selected range, a single sheet, or the entire model (including financial-model integrity checks like BS balance, cash tie-out, and logic sanity). Triggers on "audit this sheet", "check my formulas", "find formula errors", "QA this spreadsheet", "sanity check this", "debug model", "model check", "model won't balance", "something's off in my model", "model review".
name_zh: 审核电子表格
description_zh: 审核电子表格中的公式、数据和常见错误。范围可选，包括当前选中的范围、当前活动工作表或整个模型（包括财务模型完整性检查，如资产负债表平衡、现金流量表和逻辑 sanity）。触发词包括“审核此工作表”、“检查我的公式”、“查找公式错误”、“QA此电子表格”、“检查此”、“调试模型”、“模型检查”、“模型无法平衡”、“模型有错误”、“模型审核”。
---
