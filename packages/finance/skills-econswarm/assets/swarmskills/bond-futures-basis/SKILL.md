---
name_en: bond-futures-basis
description_en: Analyze the bond futures basis by pricing futures, identifying the cheapest-to-deliver, and comparing with yield curves to assess delivery option value and basis trading opportunities. Use when analyzing bond futures, computing the basis, identifying CTD bonds, calculating implied repo rates, or evaluating basis trades.
name_zh: 国债期货基差分析
description_zh: 分析国债期货基差，通过定价期货、识别最便宜可交割券，并与收益率曲线比较来评估交割期权价值和基差交易机会。用于分析国债期货、计算基差、识别CTD券、计算隐含回购利率或评估基差交易时使用。
---
