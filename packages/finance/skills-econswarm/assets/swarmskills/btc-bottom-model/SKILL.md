...
description_en: Bitcoin cycle timing model with weighted scoring system. Tracks 13 indicators across 2 categories — Daily Pulse (4 indicators, 32 points) and Weekly Structure (9 indicators, 68 points) — producing a composite 0-100 Market Heat Score. Provides both buy AND sell recommendations across the full market cycle.
description_zh: 比特币市场热力评分系统，通过13个链上、情绪和市场指标加权评分，输出0-100市场热力指数及买卖建议。覆盖ETF资金流、资金费率、多空比、恐惧贪婪指数、LTH-MVRV、NUPL、SOPR、LTH持仓比例、移动平均倍数、周线RSI和成交量趋势。
---
