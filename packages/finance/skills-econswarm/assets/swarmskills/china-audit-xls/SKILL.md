---
name_en: china-audit-xls
description_en: Audit financial models and Excel workbooks for A-share analysis. Adapts the original audit-xls skill for Chinese financial modeling standards, CAS conventions, and A-share-specific checks. Triggers on "A股模型审计", "财务模型核查", "audit model China", "audit xlsx", "模型QC", or "check model [company]".
name_zh: 中国电子表格审核
description_zh: 审计A股分析的财务模型和Excel工作簿。将原audit-xls技能适配中国财务建模标准、CAS惯例和A股特定检查。
---
