---
name_en: china-break-trace
description_en: Forensic financial analysis for A-share fund holdings and portfolio companies. Adapts the original break-trace skill for fund administration context and Chinese market standards. Triggers on "基金持仓核查", "持仓异常", "forensic fund analysis China", "持仓质量分析", or "investigate [fund] holdings".
name_zh: 中国差异追溯
description_zh: 追溯中国基金/公司两期之间的差异。适配中国企业会计准则下的科目分类和披露格式。用于中国市场的期间变动分析、盈亏驱动因素分析或预算与实际差异解释。
---
