---
name_en: china-comps
description_en: Comparable company analysis for A-share stocks. Uses AkShare MCP to build peer groups, pull financial data, compute valuation multiples (PE, PB, PS), and assess relative value within a Chinese industry sector.
name_zh: 中国可比公司分析
description_zh: A股可比公司分析。使用AkShare MCP构建同业组、提取财务数据、计算估值倍数（市盈率、市净率、市销率），并评估中国行业板块内的相对价值。
---
