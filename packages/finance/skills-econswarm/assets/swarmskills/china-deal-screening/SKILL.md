---
name_en: china-deal-screening
description_en: Screen and evaluate A-share investment opportunities. Adapts the original deal-screening skill for Chinese market data sources, A-share screening criteria, and domestic deal origination. Triggers on "A股标的筛选", "标的筛选", "screening China", "deal screening A-share", "筛选投资标的", or "screen for [criteria]".
name_zh: 中国交易筛选
description_zh: 筛选中国市场的并购和投资机会。按行业、规模、增长和估值评估标的，适配中国市场特征和监管环境。
---
