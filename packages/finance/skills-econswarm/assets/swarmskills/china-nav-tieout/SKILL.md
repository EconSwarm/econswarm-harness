---
name_en: china-nav-tieout
description_en: Net asset value (NAV) reconciliation and tie-out for Chinese funds and investment portfolios. Adapts the original nav-tieout skill for A-share holdings, Chinese fund accounting standards, and domestic custody arrangements. Triggers on "A股净值核对", "NAV计算", "NAV tie-out China", "基金净值", "net asset value [fund]", or "portfolio valuation [date]".
name_zh: 中国净值核对
description_zh: 核对中国基金净值（NAV）——将基金管理的资产估值核对到托管银行记录。用于中国基金的净值计算和投资者报告。
---
