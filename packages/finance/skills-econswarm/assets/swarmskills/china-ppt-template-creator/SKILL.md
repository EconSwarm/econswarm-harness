---
name_en: china-ppt-template-creator
description_en: Create PowerPoint templates for A-share investment presentations. Adapts the original ppt-template-creator skill for Chinese business presentation standards and firm branding. Triggers on "A股PPT模板", "投资PPT模板", "create ppt template China", "presentation template", "制作PPT模板", or "build template for [purpose]".
name_zh: 中国PPT模板创建器
description_zh: 为中国金融机构创建符合行业标准的PPT模板。适配中国投行、研究和基金的报告格式和设计惯例。
---
