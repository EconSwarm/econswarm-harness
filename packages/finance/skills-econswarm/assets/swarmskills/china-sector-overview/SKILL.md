---
name_en: china-sector-overview
description_en: Comprehensive A-share sector and industry landscape reports — market size, competitive positioning, policy environment, key A-share players, trading multiples, and thematic trends. Adapted from the original sector-overview skill for Chinese market structure and terminology. Triggers on "A股行业分析", "行业研究", "板块分析", "sector overview China", "A-share sector deep dive", "白酒/半导体/新能源 行业分析", or "[industry] landscape China".
name_zh: 中国行业概览
description_zh: 生成中国A股行业板块的深度概览报告。包含市场规模、竞争格局、监管环境、增长驱动因素和主要上市公司分析。
---
