---
name_en: china-tax-loss-harvesting
description_en: Tax-loss harvesting strategies for A-share portfolios. Adapts the original tax-loss-harvesting skill for Chinese tax rules, A-share market conventions, and domestic tax treatment. Triggers on "A股税务亏损抵扣", "亏损抵扣", "tax loss harvesting China", "税务优化", "亏损抵扣策略", or "harvest tax losses [portfolio]".
name_zh: 中国税务亏损收割
description_zh: 分析中国投资组合中的税务亏损收割机会。考虑中国资本利得税规则、交易成本和替代策略。用于中国税务优化。
---
