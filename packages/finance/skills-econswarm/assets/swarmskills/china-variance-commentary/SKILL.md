---
name_en: china-variance-commentary
description_en: Write variance commentary for A-share fund performance and portfolio changes. Adapts the original variance-commentary skill for fund accounting and Chinese fund reporting conventions. Triggers on "基金业绩点评", "组合表现分析", "variance commentary fund", "基金表现分析", "业绩归因", or "commentary on [fund] performance".
name_zh: 中国差异分析评论
description_zh: 为中国基金的业绩差异生成分析评论。解释实际与预期之间的差异，适配中国企业会计准则下的科目分类和披露格式。
---
