---
name_en: client-report
description_en: Generate professional client-facing performance reports with portfolio returns, allocation breakdowns, and market commentary. Suitable for quarterly or annual distribution. Triggers on "client report", "performance report", "quarterly report for [client]", "generate reports", or "client statement".
name_zh: 客户报告
description_zh: 为财富管理客户生成综合报告。包含投资组合摘要、业绩归因、资产配置、市场评论和个性化建议。
---
