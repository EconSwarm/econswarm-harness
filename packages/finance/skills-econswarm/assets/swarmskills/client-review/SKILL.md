---
name_en: client-review
description_en: Prepare for client review meetings with portfolio performance summary, allocation analysis, talking points, and action items. Pulls together account data into a concise meeting-ready format. Use before quarterly reviews, annual checkups, or ad-hoc client meetings. Triggers on "client review", "meeting prep for [client]", "quarterly review", "prep for [client name]", or "client meeting".
name_zh: 客户回顾
description_zh: 为客户回顾会议准备材料——投资组合业绩、目标进展、市场更新和建议调整。用于财富管理季度或年度客户回顾。
---
