---
name_en: earnings-analysis
description_en: Create professional equity research earnings update reports (8-12 pages, 3,000-5,000 words) analyzing quarterly results for companies already under coverage. Fast-turnaround format focusing on beat/miss analysis, key metrics, updated estimates, and revised thesis. Includes 1-3 summary tables and 8-12 charts. Use when user requests "earnings update", "quarterly update", "earnings analysis", "Q1/Q2/Q3/Q4 results", or post-earnings report.
name_zh: 财报分析
description_zh: 分析季度盈利发布——实际业绩vs一致预期、关键驱动因素分解、管理层指引变化和股价反应。用于盈利事后分析。
---
