...
- [ ] ✅ **Today's date written down**: **\*\***\_\_\_**\*\***
- [ ] ✅ **Earnings release date**: **\*\***\_\_\_**\*\*** (MUST be within 3 months of today)
- [ ] ✅ **Earnings call transcript date**: **\*\***\_\_\_**\*\*** (MUST match release date ±1 day)
- [ ] ✅ **10-Q/10-K filing date**: **\*\***\_\_\_**\*\*** (MUST be same quarter as release)
