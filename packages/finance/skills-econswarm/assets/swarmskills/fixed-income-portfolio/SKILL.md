---
name_en: fixed-income-portfolio
description_en: Review fixed income portfolios by pricing multiple bonds, retrieving reference data, analyzing cashflows, and running scenario analysis. Use when reviewing bond portfolios, computing portfolio duration and DV01, analyzing cashflow waterfalls, stress testing rate scenarios, or assessing portfolio composition.
name_zh: 固定收益投资组合
description_zh: 管理固定收益投资组合——久期定位、收益率曲线策略、行业配置和个券选择。用于债券组合管理和信用分析。
---
