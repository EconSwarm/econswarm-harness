---
name_en: fx-carry-trade
description_en: Evaluate FX carry trade opportunities by combining spot rates, forward points, interest rate differentials, volatility surface analysis, and historical price trends. Use when analyzing carry trades, comparing FX forward curves, assessing carry-to-vol ratios, or evaluating currency pair opportunities.
name_zh: 外汇套息交易
description_zh: 分析外汇套息交易机会。比较各国利率、评估汇率风险和回撤风险，构建套息交易策略。用于全球宏观和外汇交易场景。
---
