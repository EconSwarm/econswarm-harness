---
name_en: ib-check-deck
description_en: Investment banking presentation quality checker. Reviews a pitch deck or client-ready presentation for (1) number consistency across slides, (2) data-narrative alignment, (3) language polish against IB standards, (4) visual and formatting QC. Use whenever the user asks to review, check, QC, proof, or do a final pass on a deck, pitch, or client materials — including requests like "check my numbers", "reconcile figures across slides", "is this client-ready", or "what am I missing before I send this out".
name_zh: 投行检查清单
description_zh: 执行为投行汇报、交易更新和客户沟通而设计的全面检查清单。包含财务数据提取、格式验证和证券业标准合规性。
---
