...
def main():
    parser = argparse.ArgumentParser(description="Extract numbers from presentation content for consistency checking")
    parser.add_argument("input_file", help="Markdown file with presentation content")
    parser.add_argument("--output", "-o", help="Output JSON file (default: stdout)")
    parser.add_argument("--check", "-c", action="store_true", help="Check for inconsistencies and report")
    ...
    # Prepare output
    output = {"total_numbers": len(numbers), "by_category": defaultdict(list), "numbers": [asdict(n) for n in numbers]}
