---
name_en: china-deal-tracker
description_en: Track A-share sell-side M&A and deal pipeline with milestones, deadlines, and action items. Adapted from the original deal-tracker skill for Chinese market deal processes. Triggers on "A股交易跟踪", "并购进度", "deal tracker China", "M&A pipeline A-share", or "track progress on [deal]".
name_zh: 中国交易追踪器
description_zh: 追踪中国活跃交易的状态。监控里程碑、截止日期、文档和利益相关者沟通。适配中国并购和IPO交易流程。
---
