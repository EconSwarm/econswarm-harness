---
name_en: china-merger-model
description_en: Accretion/dilution and merger consequences analysis for A-share M&A transactions. Adapted from the original merger-model skill for Chinese GAAP, CAS accounting, and China market transaction structures. Triggers on "A股并购分析", "并购模型", "accretion dilution China", "merger model A-share", or "M&A consequences [company]".
name_zh: 中国并购模型
description_zh: 为中国并购交易构建并购财务模型。包含收购价格计算、资金来源与用途、增厚/摊薄分析。适配中国会计准则和税务规则。
---
