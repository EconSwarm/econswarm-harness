---
name_en: china-teaser
description_en: Draft anonymous one-page company teasers for A-share sell-side M&A processes. Creates compelling blind profiles without revealing the company's identity, adapted for Chinese market conventions. Triggers on "A股Teaser", "盲审材料", "blind profile China", "anonymous teaser A-share", or "sell-side teaser".
name_zh: 中国交易简介
description_zh: 为中国并购交易撰写匿名交易简介——突出投资亮点、财务摘要和交易概览，不透露公司名称。适配中国市场交易惯例。
---
