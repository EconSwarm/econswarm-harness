---
name_en: kyc-doc-parse
description_en: Parse an investor or client onboarding packet into structured KYC fields — identity, ownership, control, source of funds, and document inventory. Use as the first step of KYC screening; output feeds the rules engine.
name_zh: KYC文档解析
description_zh: 解析KYC/AML文件——从身份证、护照、公司注册文件和地址证明中提取结构化数据。用于合规和客户入驻流程。
---
