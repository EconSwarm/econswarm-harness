---
name_en: kyc-rules
description_en: Apply the firm's KYC/AML rules grid to a parsed onboarding record — assign a risk rating, list every rule outcome with the rule cited, and flag what's missing or escalation-worthy. Use after kyc-doc-parse; this skill decides nothing, it scores and routes.
name_zh: KYC规则引擎
description_zh: 根据管辖区的KYC/AML要求评估客户资料——识别缺失信息、标记风险信号并生成补救步骤。
---
