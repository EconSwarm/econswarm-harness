...
description_en: Macro liquidity monitoring and risk early-warning system. Tracks 4 core indicators (Fed Net Liquidity, SOFR, MOVE Index, Yen Carry Trade) to assess global financial system liquidity conditions and provide risk response recommendations.
description_zh: 宏观流动性监控与风险预警系统。追踪4项核心指标（美联储净流动性、SOFR隔夜融资利率、MOVE国债波动率指数、日元套利交易信号），实时评估全球金融系统流动性状况，输出流动性评级与风险应对建议。
---
