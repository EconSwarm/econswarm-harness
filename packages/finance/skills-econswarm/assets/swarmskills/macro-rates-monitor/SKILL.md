---
name_en: macro-rates-monitor
description_en: Build macroeconomic and rates dashboards combining macro indicators, yield curves, inflation breakevens, and swap rates. Use when monitoring macro conditions, analyzing yield curve shape, decomposing real vs nominal rates, assessing policy rate expectations, or evaluating financial conditions.
name_zh: 宏观利率监控
description_zh: 监控宏观利率环境——追踪央行政策、收益率曲线变动、通胀预期和跨境利差。用于固定收益、外汇和资产配置决策。
---
