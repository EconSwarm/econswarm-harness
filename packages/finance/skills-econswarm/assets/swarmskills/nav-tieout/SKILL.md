---
name_en: nav-tieout
description_en: Tie an LP statement to the fund's NAV pack — recompute the LP's capital account from the NAV components and flag any line that doesn't agree. Use before LP statements are distributed.
name_zh: 净值核对
description_zh: 核对基金净值（NAV）——将基金管理的资产估值核对到托管银行记录。用于基金净值计算和投资者报告。
---
