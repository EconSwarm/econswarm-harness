---
name_en: pptx-author
description_en: Produce a .pptx file on disk (headless) instead of driving a live PowerPoint document — for managed-agent sessions with no open Office app.
name_zh: PPT生成器
description_zh: 以无界面方式生成.pptx演示文稿文件——用于无Office应用运行的自动化代理会话中。
---
