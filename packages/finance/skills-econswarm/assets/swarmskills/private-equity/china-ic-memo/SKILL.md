---
name_en: china-ic-memo
description_en: Investment Committee memo drafting for China-focused PE/IB deals. Adapted from the original ic-memo skill for Chinese market context, terminology, and decision frameworks. Triggers on "A股投委会", "IC Memo", "investment memo China", "投委会材料", "IC memo A-share", or "committee memo [company]".
name_zh: 中国投资委员会备忘录
description_zh: 为中国投资委员会决策撰写结构化备忘录。包含投资论点、估值、风险分析和建议。适配中国私募股权和风险投资的投委会流程。
---
