---
name_en: china-returns-analysis
description_en: IRR and MOIC analysis for China-focused private equity and investment funds. Adapted from the original returns-analysis skill for RMB/USD fund structures, China market conventions, and Chinese portfolio companies. Triggers on "A股基金回报", "IRR分析", "returns China", "MOIC analysis China", "基金业绩分析", or "portfolio returns review".
name_zh: 中国投资回报分析
description_zh: 分析中国私募股权投资回报——计算IRR、MOIC、DPI和TVPI。按投资和基金层面分解业绩。适配中国LP报告。
---
