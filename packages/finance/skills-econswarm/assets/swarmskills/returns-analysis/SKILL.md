---
name_en: returns-analysis
description_en: Build quick IRR/MOIC sensitivity tables for PE deal evaluation. Models returns across entry multiple, leverage, exit multiple, growth, and hold period scenarios. Use when sizing up a deal, stress-testing assumptions, or preparing IC returns exhibits. Triggers on "returns analysis", "IRR sensitivity", "MOIC table", "what's the return at", "model the returns", or "back of the envelope".
name_zh: 投资回报分析
description_zh: 分析私募股权投资回报——计算IRR、MOIC、DPI和TVPI。按投资和基金层面分解业绩。用于LP报告和投资组合审查。
---
