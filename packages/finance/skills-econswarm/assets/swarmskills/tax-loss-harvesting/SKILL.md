---
name_en: tax-loss-harvesting
description_en: Identify tax-loss harvesting opportunities across taxable accounts. Finds positions with unrealized losses, suggests replacement securities, and tracks wash sale windows. Triggers on "tax-loss harvesting", "TLH", "harvest losses", "tax losses", "unrealized losses", or "year-end tax planning".
name_zh: 税务亏损收割
description_zh: 分析投资组合的税务亏损收割机会——识别亏损仓位、计算税务节省、建议替代证券和管理洗售规则。用于财富管理的税务优化。
---
