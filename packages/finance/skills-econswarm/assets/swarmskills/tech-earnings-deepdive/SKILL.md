...
name_en: tech-earnings-deepdive
name_zh: 科技股财报深度分析
...
description_en: Tech Stock Earnings Deep Dive Analysis and Multi-Perspective Investment Memo System. Covers 16 analysis modules (A-P), 6 investment philosophy perspectives, institutional-grade evidence standards, anti-bias framework, and actionable decision system.
description_zh: 科技股财报深度分析与多视角投资备忘录系统。覆盖16个分析模块（A-P）、6种投资哲学视角、机构级证据标准、反偏见框架和可执行决策系统。
---
...
> **The market consensus believes **_. We believe _**. They are wrong because \_\_\_.**
