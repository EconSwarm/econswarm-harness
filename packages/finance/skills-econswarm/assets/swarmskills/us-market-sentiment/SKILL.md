...
description_en: US stock market sentiment monitoring and position recommendation system. Evaluates market sentiment by tracking 5 core indicators (NAAIM, Institutional Allocation, Retail Buying, Forward P/E, Hedge Fund Leverage) and outputs sentiment ratings and position recommendations.
description_zh: 美股市场情绪监控与仓位建议系统。通过追踪5项核心指标（NAAIM持仓指数、机构股票配置、散户净买入、标普500远期市盈率、对冲基金杠杆率），评估市场情绪并输出仓位调整建议。
---
