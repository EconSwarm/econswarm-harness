...
description_en: US stock value investing analysis framework. Systematically evaluates listed companies through 4 core dimensions (ROE sustainability, debt safety, free cash flow quality, economic moat assessment), outputting investment ratings and analytical reasoning.
description_zh: 美股价值投资分析框架。通过4个核心维度（ROE可持续性、债务安全性、自由现金流质量、经济护城河评估）系统评估上市公司，输出投资评级与分析逻辑。
---
