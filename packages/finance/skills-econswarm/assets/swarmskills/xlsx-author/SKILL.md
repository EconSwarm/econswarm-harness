---
name_en: xlsx-author
description_en: Produce a .xlsx file on disk (headless) instead of driving a live Excel workbook — for managed-agent sessions with no open Office app.
name_zh: Excel生成器
description_zh: 以无界面方式在磁盘上生成.xlsx文件——用于无Office应用运行的自动化代理会话中。
---
